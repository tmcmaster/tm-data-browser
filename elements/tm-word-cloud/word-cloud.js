...
function generate() {
  ...
  layout.font(font)
    .spiral(spiral), fontSize = d3.scale[scale]().range([10, 100]),
...
(function () {
  ...
  var o = 35;
  var s = 20;
  var l = d3.select("#angles").append("svg").attr("width", 2 * (r + o)).attr("height", r + 1.5 * s).append("g").attr("transform", "translate(" + [r + o, r + s] + ")");
  ...
  var f = d3.svg.arc().innerRadius(0).outerRadius(r);
